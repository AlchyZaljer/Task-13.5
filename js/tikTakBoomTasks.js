const tasks = `
    [
        ...
        },
        {
            ...
            "answer2": { "result": false, "value": "Мозамбикский" },
            "answer3": { "result": false, "value": "Керченский" },
        ...
        {
            "question": "В какой стране нет столицы?",
            "answer1": { "result": true, "value": "Науру" },
            "answer2": { "result": false, "value": "Швейцария" },
            "answer3": { "result": false, "value": "Монако" },
            "answer4": { "result": false, "value": "Уэльс" }            
        },
        {
        ...
        {
            "question": "Где находится государство Аруба?",
